...
class Team extends React.Component <{school: string; city: string; name: string; state: string;}> {
  render() {
    ...
    return (
      <div>
      <img/>
      <h2>{teamCard.school}</h2>
      <h3>Mascot: {teamCard.name}</h3>
      <h3>Location: {teamCard.city}, {teamCard.state}</h3>
      </div>
    );
  }
}
...
function TeamList() {
  return (
    <div>
      {teamInfo.map(teamCard => <Team {...teamCard}/>)}
    </div>
  )
}
